...
const swaggerDefinition = {
  openapi: "3.0.0",
  info: {
    title: "Campus Trade API Docs",
    version: "1.0.0",
    description: "Documentation for Campus Trade API (MongoDB version)",
    license: {
      name: "MIT",
...
const options = {
  swaggerDefinition,
  apis: ["./router/*.js", "./server.js"], // API docs path
};
 ...
 * /:
 *   get:
 *     summary: The Home Page of Campus Trade
